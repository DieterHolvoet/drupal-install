 ...
 * @endcode
 */
$settings['hash_salt'] = 'Hi2mwWHfQbH1pKQVaEvRRyCrqMoUsm6iTZTp7eDgHkpcQaDMk5dhJs-BJjYHH-4BTK4uoR-_TQ';
 ...
 * header spoofing.
 *
 * Tosite_module_find_theme_templates enable the trusted host mechanism, you enable your allowable hosts
...
foreach (['local', 'development'] as $splitEnv) {
    $config["config_split.config_split.{$splitEnv}"]['status'] = $_ENV['APP_ENV'] === $splitEnv;
}

$settings['twig_sandbox_whitelisted_classes'] = [
    \Drupal\wmcontroller\Entity\AbstractPresenter::class,
    \Drupal\Core\Entity\EntityInterface::class,
...
$settings['flysystem'] = [
    ...
    'gcs' => [
        ...
        'config' => [
            ...
            'projectId' => $_ENV['GCS_PROJECT'],
            'prefix' => $_ENV['GCS_PREFIX'],
            'keyFilePath' => implode(DIRECTORY_SEPARATOR, [DRUPAL_ROOT, '..', 'gcs-service-account.json']),
            'public' => true,
        ],
